...
const GOOGLE_CLIENT_ID = '139927891496-mjf7sfmurd3o3alpecvhn9gum5aqj059.apps.googleusercontent.com';
  ...
  useEffect(() => {
    ...
    if (window.google?.accounts?.id) {
      ...
      const iv = setInterval(() => {
        if (window.google?.accounts?.id) { initGoogle(); clearInterval(iv); }
      }, 200);
